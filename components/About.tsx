    ...
    <motion.section id="about" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={fadeInUp} className="bg-zinc-900/50 py-24 border-y border-zinc-800 relative z-10">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-start text-zinc-400 text-lg leading-relaxed">
          ...
          <div className="bg-zinc-900 p-8 rounded-xl border border-zinc-800 shadow-xl self-start w-full">
            <h4 className="text-xl font-semibold text-zinc-100 mb-6">Core Engineering Focus</h4>
            <ul className="space-y-5">
              <li className="flex items-start gap-4"><span className="text-teal-500 mt-1 shrink-0">▹</span><span><strong className="text-zinc-200">ERP &amp; Business Systems:</strong> I work on customizing Microsoft Dynamics 365 Business Central using AL, and also handle NetSuite customization through scripting and form changes. I&apos;ve also worked on troubleshooting issues in SAP Business One, mainly on system behavior and data-related concerns.</span></li>
              <li className="flex items-start gap-4"><span className="text-teal-500 mt-1 shrink-0">▹</span><span><strong className="text-zinc-200">Full-Stack Engineering:</strong> I build web applications using React, Node.js / Express, Next.js, and MongoDB, with attention to structure and performance.</span></li>
              <li className="flex items-start gap-4"><span className="text-teal-500 mt-1 shrink-0">▹</span><span><strong className="text-zinc-200">AI &amp; Machine Learning:</strong> I develop projects involving object detection and gesture recognition using Python, applying machine learning in practical use cases.</span></li>
            </ul>
          </div>
        </div>
      </div>
